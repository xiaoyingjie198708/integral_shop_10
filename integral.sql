...
CREATE TABLE `tm_admin_login_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=643 DEFAULT CHARSET=utf8 COMMENT='管理员登录明细表';
...
CREATE TABLE `tm_admin_operation_log` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=4350 DEFAULT CHARSET=utf8 COMMENT='后台操作log日志';
...
CREATE TABLE `tm_goods_label_relation` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='商品标签关系表';
#
...
CREATE TABLE `tm_goods_label_relation_check` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='商品标签关系表_审核';
...
CREATE TABLE `tm_goods_label_relation_edit` (
  ...
  `update_time` datetime NOT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='商品标签关系表_编辑状态';
...
ALTER TABLE tm_member_use_code ADD is_valid tinyint(3) default 1 comment '是否有效，1-有效，0-无效';
ALTER TABLE tm_member_use_code ADD valid_type tinyint(3) default 1 comment '有效期类型，1-3个月，2-一年，3-自定义';
ALTER TABLE tm_member_use_code ADD valid_time int(11) default 0 comment '有效期，0-无限制，大于0是截止日期';
ALTER TABLE tm_member_use_code ADD is_visit tinyint(3) default 1 comment '是否回访，1-未回访，2-已回访';
ALTER TABLE tm_member_use_code ADD is_warn tinyint(3) default 0 comment '是否发送提醒短信，0-未发，1-已发';
ALTER TABLE tm_member_use_code ADD `shops_code` varchar(8) NOT NULL default '' COMMENT '商铺编码，tm_shops_base_info表中的商铺编码';

CREATE TABLE `tm_use_code_comment` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `use_id` varchar(36) NOT NULL DEFAULT '' COMMENT '消费码ID',
  `admin_uid` varchar(36) NOT NULL DEFAULT '' COMMENT '后台消费码ID',
  `content` varchar(2048) NOT NULL DEFAULT '' COMMENT '备注内容',
  `create_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '创建时间',
  `update_time` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '更新时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='消费码回访表';

ALTER TABLE tm_goods_base_info_edit ADD timeout_time datetime default '0000-00-00 00:00:00' comment '消费码，过期时间';
ALTER TABLE tm_goods_base_info_check ADD timeout_time datetime default '0000-00-00 00:00:00' comment '消费码，过期时间';
ALTER TABLE tm_goods_base_info ADD timeout_time datetime default '0000-00-00 00:00:00' comment '消费码，过期时间';

ALTER TABLE tm_member_use_code ADD buy_type tinyint default 1 comment '1正常购买，2-赠送';