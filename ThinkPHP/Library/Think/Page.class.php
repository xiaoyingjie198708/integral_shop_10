...
class Page{
    ...
    private $config  = array(
        'header' => '<li><a href="javascript:;">共 %TOTAL_ROW% 条记录</a></li>',
        'prev'   => '上一页',
        'next'   => '下一页',
        'first'  => '首页',
        'last'   => '末页',
    ...
    public function show() {
        ...
        $this->url = U(($this->url ? $this->url : ACTION_NAME), $this->parameter);
        /* 计算分页信息 */
        ...
        $up_page = $up_row > 0 ? '<li><a href="' . $this->url($up_row) . '">' . $this->config['prev'] . '</a></li>' : '<li class="disabled"><a href="javascript:;">' . $this->config['prev'] . '</a></li>';

        //下一页
        $down_row  = $this->nowPage + 1;
        $down_page = ($down_row <= $this->totalPages) ? '<li><a href="' . $this->url($down_row) . '">' . $this->config['next'] . '</a></li>' : '<li class="disabled"><a href="javascript:;">'.$this->config['next'].'</a></li>';
